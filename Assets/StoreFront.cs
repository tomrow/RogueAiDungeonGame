...
public class StoreFront : MonoBehaviour
{
    ...
    {
        AddWeaponToShop(6, "Blaster", "weapons/laserGun", 0.4f, "Compact laser blaster that", "deals moderate damage.", "Type: Pistol", 100);
        AddWeaponToShop(6, "Sword", "weapons/sword", 0.2f, "A long and durable metal", "blade.", "Type: Sword", 150);
        ...
        //old debug weapons
        AddWeaponToShop(2, "Cork gun", "weapons/corkgun", 0.1f, "Simple gun that launches cork", "cylinders.", "Type: Pistol", 100);
        AddWeaponToShop(2, "Baguette", "weapons/baguette", 0.1f, "A long loaf of bread that you", "can use to strike things.", "Type: Sword", 150);
